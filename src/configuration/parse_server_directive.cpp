...
void parse_error_page_directive(std::vector<std::string>& tokens, size_t&i, ServerContext& sc) {
...
const LocationContext& ServerContext::get_matching_location(const std::string& uri) const {
